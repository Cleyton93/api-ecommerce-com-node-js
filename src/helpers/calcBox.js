...
const calcBox = (_carrinho = null) => {
  ...
  const box = {
    ...
    message: null /* caso de erro guarda a mensagem */,
  ...
  carrinho.forEach((item) => {
    ...
    // passo N - verificando se o item tem dimensoes maiores que a caixa...
  ...
  // @nota - nao sei se é uma regra, mas por via das duvidas esta ai
